...
<body id="page-top">
	...
	<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
		<div class="container">
			<img src="<?= base_url('assets/img/lamongan1.png'); ?>" alt="logo" width="40" height="40" class="mr-2">
			<a class="navbar-brand js-scroll-trigger" href="#page-top">PENGAJUAN FORMULIR</a>
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav text-uppercase ml-auto">
					...
					<li class="nav-item"><a class="nav-link js-scroll-trigger" href="#struktur">Syarat Berkas</a></li>
